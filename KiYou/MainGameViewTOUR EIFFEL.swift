...
struct MainGameViewTOUREIFFEL: View {
   ...
   // var oneKeyMainGame : Key
    var EiffelTowerKey = [EiffelTowerKeyList]
    ...
    var body: some View {
        ZStack {
            Map(coordinateRegion: $keyPlace, annotationItems: EiffelTowerKeyList) { eachKey in
...
struct MainGameViewTOUREIFFEL_Previews: PreviewProvider {
    static var previews: some View {
        MainGameViewTOUREIFFEL(oneMainGame: testMainGame2, timeRemaining:testMainGame2.expectedMinutesToFinish)
    }
}
