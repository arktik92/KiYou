...
//                  }.frame(width: 370, height: 75, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
...
struct BusViewBusViewMontmartre_Previews: PreviewProvider {
    static var previews: some View {
        BusViewMontmartre(myMinibus: busMontmartre)
    }
}
