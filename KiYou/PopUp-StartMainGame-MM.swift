...
struct PopUp_StartMainGameMM: View {
...
//                                    .animation(Animation.easeInOut(duration: 1).repeatForever(autoreverses: false))
                ...
                NavigationLink(
                    destination: MainGameViewMONTMATRE(oneMainGame: testMainGame3),
...
struct PopUp_StartMainGameMM_Previews: PreviewProvider {
